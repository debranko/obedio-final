...
export function RepeatersList() {
  // Use our custom hook for device management
  const {
    filteredDevices,
    loading,
    filters,
  ...
  const handleConnectionTypeFilterChange = (type: ConnectionFilter) => {
  ...
  const handleViewDetails = (repeater: RepeaterDevice) => {
    ...
    <div className="space-y-6">
      ...
      {(filters.statusFilter !== 'all' || 
        ...
        <div className="text-sm text-muted-foreground flex items-center">
          ...
          {filters.statusFilter !== 'all' && (
            <span className="bg-slate-100 text-slate-800 px-2 py-1 rounded-md text-xs mr-2">
      ...
      <div className="rounded-md border">
        <Table>
          ...
          {filteredDevices.length > 0 && (
            <TableCaption>
              Showing {filteredDevices.length} repeaters
            </TableCaption>
          )}
        </Table>
      </div>

      {/* Repeater Details Dialog */}
      {selectedRepeater && (
        <RepeaterDetails
