...
import { RepeatersList } from "./repeaters-list"
...
export function DeviceManagerTabs({ className }: DeviceManagerTabsProps) {
  return (
    <Tabs defaultValue="buttons" className={className}>
